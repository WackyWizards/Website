...
export const metadata = {
  ...
  description:
    'Our privacy policy explains what data we collect, how we use it, and how you can control it across our services.',
};
        ...
        <div className="prose prose-invert prose-lg max-w-none text-gray-300">
          ...
          <section className="mb-12">
            ...
            <div className="space-y-8">
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6">
                ...
                <p className="mb-4">
                  When you register through Discord with our backend services, we collect and store:
                </p>
              ...
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6">
                ...
                <p className="mb-4">
                  When you register through Steam with our backend services, we collect and store:
                </p>
                <ul className="space-y-2 text-gray-300">
                  <li className="flex items-start">
                    <span className="text-blue-400 mr-2">•</span>
              ...
              <div className="grid gap-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <span className="text-gray-300">
                      {' '}
                      Processing required to provide our gaming services
                    </span>
                  </div>
                </div>
                <div className="flex items-start">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <span className="text-gray-300">
                      {' '}
                      Optional features like account linking and non-essential cookies (you can
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6">
              <div className="grid gap-3">
                <div className="flex items-start">
                  ...
                  <span>
                    Enable core gameplay features including leveling, XP tracking, and progression
                    systems
                  </span>
                </div>
                <div className="flex items-start">
                  <span className="text-blue-400 mr-3">•</span>
                  <span>
                    Associate statistics and achievements with your account across platforms
                  </span>
                </div>
                <div className="flex items-start">
                  <span className="text-blue-400 mr-3">•</span>
          ...
          <section className="mb-12">
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 space-y-4">
              <p>
                Your registered user data is stored securely in a private database with restricted
                access controls.
              </p>
              <p>
                <span className="font-semibold text-white">Data Location:</span> Our primary data
                server is located in Helsinki, Finland. We use reputable hosting providers including
                Hetzner who maintain appropriate data protection standards.
              </p>
            </div>
          </section>
          ...
          <section className="mb-12">
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6">
              <p className="mb-4">
                If you are located outside our primary server region, your data may be transferred
          ...
          <section className="mb-12">
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 space-y-6">
              <p>
                We do not sell your personal data. We may share data only in these limited
                circumstances:
              </p>
              ...
              <div className="grid gap-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <span className="text-gray-300">
                      {' '}
                      Trusted partners who help operate our services (hosting, analytics)
                    </span>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <span className="text-gray-300">
                      {' '}
                      Website usage data may be shared with analytics providers based on your cookie
                      preferences
                    </span>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <span className="text-gray-300">
                      {' '}
                      In case of merger, acquisition, or asset sale (with notice)
                    </span>
                  </div>
                </div>
                <div className="flex items-start">
              ...
              <div className="border-t border-white/10 pt-4">
                <p className="mb-4">
                  <span className="font-semibold text-white">Third-Party Services:</span> When you
                  use our website, some data may be automatically shared with third-party services
                  we use, based on your cookie preferences:
                </p>
                <div className="grid gap-3">
                  <div className="flex items-start">
                    <span className="text-blue-400 mr-3 font-bold">•</span>
                    <div>
                      ...
                      <span className="text-gray-300">
                        {' '}
                        If you consent to analytics cookies, usage data is shared for website
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <span className="text-gray-300">
                        {' '}
                        Technical data necessary for website operation (always required)
                      </span>
                    </div>
                  </div>
                </div>
              ...
              <div className="grid gap-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <span className="text-gray-300">
                      {' '}
                      Data retained while your account is active and for 2 years after last activity
                    </span>
                  </div>
                </div>
                <div className="flex items-start">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <span className="text-gray-300">
                      {' '}
                      Permanently removed within 30 days of deletion request
                    </span>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <span className="text-gray-300">
                      {' '}
                      Stored until you change them or clear your browser data
                    </span>
                  </div>
                </div>
                <div className="flex items-start">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <span className="text-gray-300">
                      {' '}
                      Data in backups is deleted according to our backup retention schedule (maximum
                      1 year)
                    </span>
                  </div>
                </div>
          ...
          <section className="mb-12">
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 space-y-4">
              <p>
                Account linking is entirely optional and requires your explicit consent. When you
                link accounts, we can:
              </p>
              <div className="grid gap-3">
                <div className="flex items-start">
                  <span className="text-blue-400 mr-3">•</span>
              ...
              <p>
                You can unlink accounts and request deletion of linked data at any time by
                contacting us.
              </p>
            </div>
          </section>
          ...
          <section className="mb-12">
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 space-y-6">
              <p>
                We use different types of cookies and tracking technologies to provide and improve
                our services. You have control over which cookies we use through our cookie consent
                banner. Only necessary cookies are enabled by default; optional cookies are only set
                if you provide explicit consent. You can change your preferences at any time using
                the banner or your browser settings.
              </p>
              ...
              <div>
                ...
                <div className="grid gap-3">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <span className="text-gray-300">
                        {' '}
                        When you first visit our website, you can accept all, reject all, or
                ...
                <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-4 mt-4">
                  <p className="text-yellow-200">
                    <span className="font-semibold">Note:</span> Disabling certain cookies may limit
                    website functionality and affect your user experience. Necessary cookies cannot
              ...
              <div>
                ...
                <p className="mb-4">
                  When you consent to analytics or marketing cookies, we may use the following
                ...
                <div className="grid gap-3">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <span className="text-gray-300">
                        {' '}
                        For website analytics and user behavior insights
                      </span>
                    </div>
                  </div>
                </div>
                <p className="mt-4 mb-2">
                  Each service has its own privacy policy governing how they handle your data. We
              ...
              <div>
                ...
                <p>
                  Our website respects your cookie choices made through our consent banner. However,
                  we do not respond to Do Not Track (DNT) signals from browsers as there is no
                  universal standard for how to interpret these signals.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-12">
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 space-y-4">
              ...
              <p>
                ...
                knowingly collect data from children under 13 in the United States.
              </p>
              <p>
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 space-y-6">
              ...
              <div>
                ...
                <div className="grid gap-3">
                  ...
                  <div className="flex items-start">
                    <span className="text-blue-400 mr-3">•</span>
                    <span>
                      Withdraw consent for optional processing (including cookie preferences)
                    </span>
                  </div>
                  <div className="flex items-start">
                    <span className="text-blue-400 mr-3">•</span>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
                <p className="text-blue-200">
                  <span className="font-semibold">Response Time:</span> We will respond to privacy
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 space-y-4">
              ...
              <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-4">
                <p className="text-green-200">
                  <span className="font-semibold">Processing Time:</span> Deletion requests are
                  processed within 14 days. Some data may be retained longer if required by law or
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 space-y-4">
              ...
              <div className="grid gap-3">
                ...
                <div className="flex items-start">
                  <span className="text-blue-400 mr-3">•</span>
                  <span>
                    Notify users via our official discord server and in-service notifications.
                  </span>
                </div>
                <div className="flex items-start">
                  <span className="text-blue-400 mr-3">•</span>
              ...
              <p>
                Continued use of our services after policy updates constitutes acceptance of the
                revised policy.
              </p>
            </div>
          </section>
            ...
            <div className="bg-gradient-to-r from-blue-500/10 to-emerald-500/10 backdrop-blur-sm border border-white/10 rounded-xl p-8">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <span className="text-gray-300 ml-2">
                      We aim to respond within 48 hours for general inquiries and within 30 days for
              ...
              <div className="mt-6 p-4 bg-white/5 border border-white/10 rounded-lg">
                <p className="text-sm text-gray-400">
                  Note: For privacy-related requests, we recommend using email for verification and
          ...
          <div className="border-t border-white/10 pt-8">
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6">
              <p className="text-sm text-gray-400 text-center">
                By using our services, you agree to the terms outlined in this privacy policy. If
