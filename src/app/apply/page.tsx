            ...
            <main className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 py-16">
                <div className="relative mx-auto max-w-7xl px-6 md:px-10 pt-6 md:pt-10">
                    <header className="mb-12 text-center border-b border-white/10 pb-8">
                        ...
                        <p className="text-gray-400">We&apos;re always looking for passionate, creative and dedicated individuals to join our team.</p>
                        <p className="text-gray-400">If you&apos;re interested in working with us, please fill out the application form below.</p>
                    </header>
