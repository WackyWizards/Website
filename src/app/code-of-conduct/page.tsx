                ...
                <div className="mx-auto px-6 md:px-10 pt-6 md:pt-10 text-black">
                    ...
                    <div className="prose prose-gray max-w-none">
                        ...
                        <ul className="list-disc list-inside mb-4 ml-4">
                            ...
                            <li>Follow the <a href="https://discord.com/terms">Discord Terms of Service</a> if participating in our server.</li>
                        </ul>

                        <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-800">2. Unacceptable Behavior</h2>
                        <ul className="list-disc list-inside mb-4 ml-4">
                            <li>Violence or threats of violence against others.</li>
                            <li>Discriminatory jokes, language, or behavior targeting protected characteristics.</li>
                        ...
                        <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-800">3. Consequences Of Unacceptable Behavior</h2>
                        <p>
                            Unacceptable behavior from any community member, including sponsors and those with decision-making authority, will not be tolerated.

                            Anyone asked to stop unacceptable behavior is expected to comply immediately.

                            If a community member engages in unacceptable behavior, the staff team may take any action they deem appropriate, up to and including a temporary ban or permanent expulsion from the community without warning (and without refund in the case of a paid event or service).
                        ...
                        <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-800">5. License and Attribution</h2>
                        <p>
                        ...
                        <p className="text-sm text-gray-600">
                            Questions or concerns? Email us at <a href="mailto:contact.kuo.team@gmail.com">contact.kuo.team@gmail.com</a>
                        </p>
                    </div>
                </div>
            </main>
